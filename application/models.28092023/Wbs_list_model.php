		...
		$aids=implode(",",$children_ids);
		 ...
		 /* }*/
		  ...
		  if ($result_activity->num_rows() !=0) {
			...
			echo "<td><textarea readonly>" . $row_activity['start_date'] . "</textarea></td>
...
public function tree_process_edit($id,$mp_id ,$indent=1,$projectid) {
	...
	//print_r($data);
	 ...
	 for($i=0;$i<$result_depth_activity;$i++){
		  ...
		  echo " <td>	<input value='' placeholder='dd/mm/YYYY'  class='stdate' name='start_date[]' type='text'></td>
		...
		/* }*/
		  ...
		  if ($result_activity->num_rows() !=0) {
			...
			echo "<td><input type='text' value='" . $row_activity['start_date'] . "' class='stdate' placeholder='dd/mm/YYYY'  name='start_date[]' ></td>
     ...
     foreach ($result_process->result_array() as $row_process) {
		...
		if(count($children_ids)>0) { 	
		  ...
		  if ($result_activity->num_rows() !=0) {
			...
			echo "<td  align='left'>" . $row_activity['start_date'] . "</td>
