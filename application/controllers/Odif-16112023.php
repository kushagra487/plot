...
error_reporting(0);
	 ...
	 */
	public function send_job_card_members1(){
		...
		foreach($all_projects as $all_project){
			...
			foreach($odif as $value){
				...
				$fiveMinutesAfter = strtotime($current_time . ' +5 minutes');
				...
				*/
				if($all_project['project_id'] == 315) {	
					...
					if($server_time > $current_time && $server_time < $server_time + 300){
...
$this->email->from('plot@pboplus.com');
		 ...
		 $this->email->to('vnardiya.eng@gmail.com');
...
@ ".date("Y")." PBOPlus Consulting Services Ltd. All rights reserved.</p>
		...
		public function send_odif_report1(){
...
@ ".date("Y")." PBOPlus Consulting Services Ltd. All rights reserved.</p>
    ...
    <tr>
		 ...
		 * odif/odif_reminder
		 */
		public function odif_reminder1(){
			$all_projects = $this->odif_model->get_all_projects();
