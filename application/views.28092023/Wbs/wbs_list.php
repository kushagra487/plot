    ...
    <div class="row">
      ...
      <span class="input-group-btn green_btn ">
        ...
        <div class="col-md-2 col-xs-6">
            ...
            <a href="<?php echo  base_url() . 'wbs_list/export_data_in_excel/' . $this->uri->segment('3'); ?>" title="Final" id="export_wbs"><i class="fa fa-download" aria-hidden="true"></i> Export</a>
            </div>
        </div>
         <div class="col-md-2 col-xs-6">
        	<div class="curve_btn green_btn">
            <a href="<?php echo base_url() . 'odif/index/' . $this->uri->segment('3'); ?>" title="add" id="add_member"><i class="fa fa-file-text-o" aria-hidden="true"></i> ODIF</a>
            </div>
        </div>
        <div class="col-md-2 col-xs-6">
        	<div class="curve_btn green_btn">
            <a href="<?php echo base_url() . 'wbs_list/share_wbs/' . $this->uri->segment('3'); ?>" title="add" id="add_member"  data-toggle="modal" data-target="#myModal_share"><i class="fa fa-share-alt" aria-hidden="true"></i> Share</a>
            </div>
        </div>
          ...
          <div class="col-md-2 col-xs-6">
            ...
            <a href="<?php echo  base_url() . 'wbs/index/' . $this->uri->segment('3'); ?>" title="Final" id="export_wbs"><i class="fa fa-plus" aria-hidden="true"></i> Add WBS</a>
            </div>
        </div>
