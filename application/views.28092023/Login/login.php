    ...
    <div class="tab-content">
        <div id="login" class="tab-pane active">
          <?php 
                ...
                <input type="text" name="username"  placeholder="Username" class="form-control top" required="required" >
                <input type="password" name="password"  placeholder="Password" class="form-control bottom" required="required" >
                
         
         <p class="text-center">  <input class="trmchk" name="termcond" value="" required type="checkbox">
			 <a href="<?php echo base_url()?>terms.php" target="_blank"><b>I Agree to Terms & Conditions.</b></a></p>
             
             <div class="curve_btn green_btn text-center">
                <button class="submit btn-lg" type="submit">Sign in</button>
         </div>
