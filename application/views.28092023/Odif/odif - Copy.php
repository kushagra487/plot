		...
		<div class="row">
			<div class="col-md-12 col-sm-12 col-xs-12">
				<div class="x_panel x_panel1">
					...
					<form method="post"><input type="text"  name="sdate" readonly="readonly" class="form-control single_cal1"  placeholder="" aria-describedby="inputSuccess2Status" style="width:200px !important;">&nbsp;
                    
                    <input type="text"  name="edate" readonly="readonly" class="form-control single_cal1" id="single_cal2" placeholder="" aria-describedby="inputSuccess2Status" style="width:200px !important;">
                    
                   &nbsp;<input type="submit" name="odifsort" value="Filter" style="width:100px !important;" /></form> 
					<div class="x_content">
