        ...
        <?php
        		...
        		<div class="col-sm-6 col-md-6 col-lg-3">
                	<div class="proj_desc">
                        ...
                        <a href="<?php echo base_url(); ?>odif/index/<?php echo $value['project_id']; ?>/" class="action_odif"data-toggle="tooltip" title="ODIF"><img src="<?php echo  base_url();?>images/odif_icon.png" alt=""/></a>
                        </span>
