							...
							<tbody class="drag_drop">
								<?php 
									...
									foreach($details as $key => $value){
										...
										if($value['role'] == 'Project Manager' or $value['role'] == 'Team Member'){
											?>
											<tr>
												<td><?php echo $i;?></td>
												...
												<td>
													...
													<a onClick="alert('Do you want to delete this user?');"  href="<?= base_url();?>add_users/delete_users/<?php echo $value['id']; ?>/" title="delete">Delete</a>
												</td>
											</tr>
											<?php
											$i++;
