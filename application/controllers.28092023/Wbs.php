		...
		public function index() {
			...
			if($loggedin == TRUE) {
				...
				$sql_mp="select mp_id,unique_code from mega_process WHERE mp_name='".$parent_value_mp."' AND status=0 ORDER BY mp_id DESC LIMIT 1";
					...
					$actid_unique++;
					$sql_actiity_ins="INSERT INTO activity (activity_name,start_date,finish_date,assigned_person,resources,template_reference,project_id,dependent_on,last_modified,template_document,comments) VALUES ('".addslashes($_POST['rowC'.$newj][$l])."','".$_POST['start_date'][$l]."','".$_POST['end_date'][$l]."','".$_POST['responsibilities'][$l]."','".$_POST['resources'][$l]."','".$_POST['template_reference'][$l]."','".$this->uri->segment('3')."','".$_POST['dependency'][$l]."',now(),'".$img_name."','".$_POST['comments'][$l]."')";
