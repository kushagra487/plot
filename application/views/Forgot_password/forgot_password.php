...
<link rel="stylesheet/less" type="text/css" href="<?= base_url();?>vendors/assets/less/theme.less">
	...
	<div class="plotlogo">
		  ...
		  <form method="post" action="<?php echo base_url()?>Forgot_password/check">
        <div class="login">
    ...
    <div class="tab-content">
        <div id="login" class="tab-pane active">
          <?php 
                ...
                <input type="email" name="username"  placeholder="Enter Your Email" class="form-control top" required="required" >
             ...
             <div class="curve_btn green_btn text-center">
                <button class="submit btn-lg" type="submit">Submit</button>
         </div>
