                    ...
                    <ul class="text-right list-unstyled">
                        ...
                        <div id="custom-search-input">
                            <div class="input-group col-md-12">
                                <input type="text" name="uname" class="  search-query form-control" placeholder="Search" value="<?php echo $_POST['uname']?>" />
									...
									foreach($details as $key => $value){
										...
										if($value['role'] == 'Admin'){
											...
											<tr>
												...
												<td  class="col-xs-1">
													<a href="<?php echo base_url();?>add_users/edit_users/<?php echo $value['id']; ?>/" title="edit"><i class="fa fa-pencil" aria-hidden="true"></i></a>
												</td>
											</tr>
											<?php
											$i++;
											...
											<tr>
												...
												<td><?php echo $value['designation'];?></td>
												<td>
													<a href="<?= base_url();?>add_users/edit_users/<?php echo $value['id']; ?>/" title="edit"><i class="fa fa-pencil" aria-hidden="true"></i></a>
													<a onClick="return doconfirm();"  href="<?= base_url();?>add_users/delete_users/<?php echo $value['id']; ?>/" title="delete"><i class="fa fa-close" aria-hidden="true"></i></a>
												</td>
											</tr>
											<?php
											$i++;
