    ...
    <div class="row">
      <div class="col-xs-12">
        ...
        <div class="row">
        	...
        	<div class="col-md-4 ">
             <form <?php if($role=="Admin" || $role=="Editor" || $role=="Team Member") { echo ""; } else if($role=='Team Member' || ($this->session->userdata['user_id']!=$powner['powner']) ) { ?> class="disabledbtn" <?php } ?> method="post" enctype="multipart/form-data" action="<?php echo base_url()?>/wbs_list/import">
      ...
      <span class="input-group-btn green_btn ">
        ...
        <div class="col-md-2 col-xs-6">
          ...
          <?php if($wbs_data==''){?>
          <div class="col-md-2 col-xs-6">
        	<div class="curve_btn red_btn <?php if($role=="Admin" || $role=="Editor" || $role=="Team Member") { echo ""; } else if($role=='Team Member' || ($this->session->userdata['user_id']!=$powner['powner']) ) { ?> disabledbtn <?php } ?>">
        ...
        <div class="col-md-2 col-xs-6">
        	<div class="curve_btn green_btn <?php if($role=="Admin" || $role=="Editor" || $role=="Team Member") { echo ""; } else if($role=='Team Member' || ($this->session->userdata['user_id']!=$powner['powner']) ) { ?> disabledbtn <?php } ?>">
