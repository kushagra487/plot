...
/*foreach($pmpermissionwbs as $key => $value){ 

 $value['wbs_permission'];

}

//print_r($pmwbsedit['wbs_permission']);

echo $pmpermissionwbs['wbs_permission'];
die;
*/
?>
<script>
		...
		<div class="row">
			<div class="col-md-12 col-sm-12 col-xs-12">
				<div class="x_panel">
                    ...
                    <img class="img-responsive" src="<?= base_url();?>project_uploads/<?php echo $project_details['project_logo']; ?>"/>
                        </div>
         
                      <h3 class="logo-name" style="color: #fff; font-size: 18px;"><?php echo $role; echo $project_details['project_name']; ?></h2>
                        </div>
                ...
                <div class="col-md-2 col-sm-2 col-xs-12">
                       ...
                       <div class="project-button clearfix">
                        <a href="#" class="share" title="share" id="import_wbs" data-toggle="modal" data-target="#final_approve"><i class="fa fa-share-alt" aria-hidden="true"></i> Approve</a>
                       </div>
                       <div class="project-button clearfix">
                     <a href="#" class="share" title="share" id="import_wbs" data-toggle="modal" data-target="#reject"><i class="fa fa-share-alt" aria-hidden="true"></i> Reject</a>
                       </div>
            ...
            <?php endif; ?>
                  <ul class="nav navbar-right panel_toolbox wbs-button">
                     ...
                     <?php }else{ if($user_detail['role']=='Admin' || $user_detail['role']=='Editor' || $pmpermissionwbs['wbs_permission']=='1' || $pmpermissionwbs['wbs_permission']=='1'){ ?>
                     ...
                     <?php }} //$user_detail['role']=='Admin' || $user_detail['role']=='Editor' || $pmpermissionwbs['wbs_permission']='1' || $tmpermissionwbs['wbs_permission']='1' ?>
  ...
  <div class="modal-dialog" role="document">
    ...
    <form method="post">
      ...
      <div class="modal-body">
         <input type="text" name="sharetitle" />
      </div>
      <div class="modal-body">
      ...
      <div class="modal-body">
         ...
         <textarea name="sharemessage" cols="100" rows="5"></textarea>
      </div>
